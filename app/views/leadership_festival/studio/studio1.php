...
<head>
	...
	<title>Leadership Festival || Studio 1</title>
...
<img src="../../lobby_leadership_festival/img/leadership_festival/studio/layar_noexit.jpg" class="imgback" style="position: fixed;bottom: 0;right: 0;width: 100%;height: 100%;">
        ...
        <div class="kuKEPR">
            ...
            <source src="vid/ManageChangeDHO.mp4" type="video/mp4">
            </a>
            </video>
            <!-- <iframe width="100%" height="100%" src="https://www.youtube.com/embed/4JJFJsmliUU?autoplay=1&controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                <!-- iframe id="videoOne"  width="100%" height="100%" src="https://www.youtube.com/embed/4ncYUuD83Wc?autoplay=1&controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->

        </div>

        <!-- <div id="munculpost" class="kuKEPRex" onclick="popPostTest()" style="display:none;">
                <button class="btn btn-primary" onclick="popPostTest()">Post Test & Exit</button>
                <button class="btn btn-success" style="width: 100%;">Exit & Feedback</button>
        </div> -->

        <div id="munculpostexit" class="kuKEPRex" onclick="popPostTest()" style="display:block;">
                    <!-- <button class="btn btn-primary" onclick="popPostTest()">Post Test & Exit</button> -->
                    <a href="studio1_posttest.php">
                    <button class="btn btn-success" style="width: 100%;">Exit & Feedback</button>
                    </a>
        </div>

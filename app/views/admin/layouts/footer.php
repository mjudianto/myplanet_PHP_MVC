...
<script>
	$(document).ready(function() {
		...
		var table = $('#testReportTable').DataTable({
			...
			"serverSide": true,
			"ajax": {
				"url": "<?= BASEURL ?>report/dataTableProcessing",
				"method": "POST",
			},
			"columns": [
				{ "data": "userNik" },
			...
			"lengthMenu": [10, 50, 100, 500, 1000, 2000, 3000, 4000, 5000] // add this line
		});
		...
		var table = $('#lessonReportTable').DataTable({
			...
			"serverSide": true,
			"ajax": {
				"url": "<?= BASEURL ?>report/lessonReportTableData",
				"method": "POST",
			},
			"columns": [
				{ "data": "userNik" },
		...
		var table = $('#sopikLessonReportTable').DataTable({
			dom: '<"row top"<"col-lg-4 col-md-4 col-sm-12 mb-2"B><"col-lg-4 col-md-4 col-sm-12 mb-2"l><"col-lg-4 col-md-4 col-sm-12 mb-2"f>>rtip',
			"processing": true,
			"serverSide": true,
			"ajax": {
				"url": "<?= BASEURL ?>sopikmanagement/sopikLessonRecord",
				"method": "POST",
			},
			"columns": [
				{ "data": "userNik" },
